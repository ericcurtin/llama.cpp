...
// libmediagen: latent diffusion media generation (image, video, audio)
//
// A diffusion transformer conditioned on the hidden states of a text model loaded with libllama,
// decoded with a VAE. Experimental API, see mediagen-cli.cpp for usage.
